...
public class ModelFactoryImpl
        implements ModelFactory, RestConstants
{
    ...
    /**
     * @author 212672942 
     * Start adding variables from the old class FixtureFactory
	 ...
	 *
	 *@author 212672942: Moved this method to here from FixtureFactory class that was implementing interface IFixtureFactory.
	 *We donot need those now as ModelFactory has all these methods now.
	 */
    @Override
