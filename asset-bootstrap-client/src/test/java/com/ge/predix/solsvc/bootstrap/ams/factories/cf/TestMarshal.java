...
public class TestMarshal 
{
    ...
    private static final Logger log = LoggerFactory.getLogger(TestMarshal.class);
    ...
    public void testMarshal()
    {
        ...
        log.debug(json);
       Assert.assertEquals(json, "{\"uri\":\"/engine/ENG1.23\",\"flowRate\":1.2}");
    ...
    public void testExtendsModelMarshal()
    {
        ...
        log.debug(json);
        Assert.assertEquals(json, "{\"@type\":\"JetEngine\",\"uri\":\"/engine/ENG1.23\",\"serialNo\":12345}");
    }
    ...
    /**
     *  - in ReferenceApp we don't know what models you'll acutally create.  So let's be more anonymous.
     */
    @SuppressWarnings("nls")
    @Test
    public void testPolymorphicModelUnmarshal()
    {
        ...
        Assert.assertEquals(modelList.getModel().get(0), modelList2.getModel().get(0));
    }
    ...
    public void testPolymorphicBaseModelListUnmarshal()
    {
        ...
        this.jsonMapper.addAllXmlSeeAlsoSubtypes(AviationModel.class);
        List<JetEngine> modelList2 = this.jsonMapper.fromJsonArray(json,JetEngine.class);
        Assert.assertEquals(((AviationModel) models.get(0)).getSerialNo(), modelList2.get(0).getSerialNo());
    }
    ...
    public void testNonPolymorphicSaveBeforePolymorphicModelUnmarshal()
    {
        ...
        this.jsonMapper.addAllXmlSeeAlsoSubtypes(AviationModel.class);
        List<JetEngine> modelList2 = this.jsonMapper.fromJsonArray(json, JetEngine.class);
        Assert.assertEquals(list.get(0).getSerialNo(), modelList2.get(0).getSerialNo());
    }
}
