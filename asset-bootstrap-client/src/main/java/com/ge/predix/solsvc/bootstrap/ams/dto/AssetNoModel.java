...
public class AssetNoModel {
     ...
     */
    @JsonProperty("meters")
    private LinkedHashMap<String,  AssetMeter> meters;
    ...
    @JsonProperty("meters")
    public LinkedHashMap<String,  AssetMeter> getMeters() {
        return this.meters;
    }
    ...
    @JsonProperty("meters")
    public void setMeters(LinkedHashMap<String,  AssetMeter> meters) {
        this.meters = meters;
    }
