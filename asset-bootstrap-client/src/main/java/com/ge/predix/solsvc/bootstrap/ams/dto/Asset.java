...
public class Asset extends CustomModel {
    ...
    /**
     * Map. key is meter key and value is AssetMeter.
     * 
     */
    @JsonProperty("meters")
    private LinkedHashMap<String,  AssetMeter> assetMeter;
    ...
    @JsonProperty("meters")
    public LinkedHashMap<String,  AssetMeter> getAssetMeter() {
        return this.assetMeter;
    }
    ...
    @JsonProperty("meters")
    public void setAssetMeter(LinkedHashMap<String,  AssetMeter> assetMeters) {
        this.assetMeter = assetMeters;
    }
